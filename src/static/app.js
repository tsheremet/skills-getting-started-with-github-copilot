document.addEventListener("DOMContentLoaded", () => {
  ...
  function showMessage(text, type) {
    // Display a short feedback message for sign-up and removal actions.
  ...
  async function fetchActivities() {
    // Load the latest activities and rebuild the list plus the dropdown.
    try {
  ...
  activitiesList.addEventListener("click", async (event) => {
    // Handle clicks on participant removal buttons inside each activity card.
