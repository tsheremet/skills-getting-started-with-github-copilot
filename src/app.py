...
activities = {
    ...
    "Soccer Team": {
        "description": "Team sport for developing fitness, teamwork, and game strategy",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["maria@mergington.edu", "liam@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming skills and participate in friendly races",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and theater production practice",
...
def unregister_participant(activity_name: str, email: str):
    ...
    # Check that the requested activity exists before updating it.
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")

    activity = activities[activity_name]

    # Ensure the participant is currently registered before removing them.
    if email not in activity["participants"]:
        raise HTTPException(status_code=404, detail="Participant not found")

    # Remove the participant from the activity roster.
